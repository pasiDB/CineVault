...
Color getMovieBackgroundColor(BuildContext context, int tmdbId) =>
    switch (tmdbId) {
      _ when isHarryPotter(tmdbId) =>
        const Color(0xFF641E1E).withValues(alpha: 0.8),
      _ when isMatrix(tmdbId) => const Color(0xFF0e1b0f).withValues(alpha: 0.8),
      _ when isStarwars(tmdbId) =>
        const Color(0xFF201652).withValues(alpha: 0.8),
      _ when isSpiderman(tmdbId) =>
        const Color(0xFFea1818).withValues(alpha: 0.6),
      _ when isAvengers(tmdbId) =>
        const Color(0xFF460061).withValues(alpha: 0.8),
      ...
      _ when isDeadpool(tmdbId) =>
        const Color(0xFF8f2121).withValues(alpha: 0.8),
      _ when isDune(tmdbId) => const Color(0xFF3d2d1c).withValues(alpha: 0.8),
      _ when isMonsters(tmdbId) =>
        const Color(0xFF5aff49).withValues(alpha: 0.8),
